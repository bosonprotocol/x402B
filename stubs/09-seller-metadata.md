...
```jsonc
{
  ...
  "channels": {
    "x402b": {
      ...
      "supportedDeliveryTransports": ["atomic-http", "email", "xmtp"]
    }
  }
}
```
...
2. **Discovery:** offer-discovery tools (Bazaar et al.) can pre-filter sellers by accepted channels and delivery transports before the buyer ever fires a GET.
...
- Public-key publication for webhook delivery transport.
